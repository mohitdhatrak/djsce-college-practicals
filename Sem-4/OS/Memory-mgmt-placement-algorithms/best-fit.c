...
void bestFit(int blockSize[], int m, int processSize[], int n, int holeSize[], int sortedBlock[])
{
    int i, j;
    int allocation[n];
...
void main()
{
    ...
    bestFit(blockSize, m, processSize, n, holeSize, sortedBlock);
}
